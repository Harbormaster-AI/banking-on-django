...
urlpatterns = [
    ...
    path('assignThirdPartyProvider', ConsentView.assignThirdPartyProvider, name='assignThirdPartyProvider'),
    path('unassignThirdPartyProvider', ConsentView.unassignThirdPartyProvider, name='unassignThirdPartyProvider'),
